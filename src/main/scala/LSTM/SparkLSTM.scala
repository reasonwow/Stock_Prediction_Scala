...
object SparkLSTM {
  def main(args: Array[String])= {
    ...
    val result: Result = StockPricePredictionLSTM.predict("/Users/kym1992/STUDY/NEU/CSYE7200/Dataset/nyse/prices-split-adjusted.csv", "MSFT", 0.90)
  ...
  def saveAsCsv(result: Result): Unit =  {
    ...
    ("src/main/resources/MSFT.csv")) //replace the path with the
